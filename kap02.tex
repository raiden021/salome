...
Zunächst wollen wir eine sogenannte Energiemessung des
Elektronenstrahls mithilfe
eines Dipolmagneten durchführen. Die
...
Strom des Dipols, der proportional zur Dipolstärke
...
Wir messen eine Reihe von Wertepaaren für $I$ und $x$ (siehe Tabelle
\ref{tab:dipolabl}),
ermitteln mithilfe linearer Regression einen Wert für $\frac{dx}{dI}$,
woraus wir mit \eqref{eq:dipolabl} einen Wert für $\beta \gamma$ erhalten.
Dieser ist $\beta\gamma = 0,1675$. Für $\gamma = \sqrt{1+\beta^2\gamma^2}$
...
schliesslich für seine kinetische Energie $E_{\text{kin}} = 7,121 \text{ keV}$
