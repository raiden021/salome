...
unter Anderem die Größen $\langle x^2\rangle(z)$,
$\langle xx'\rangle(z)$ und $\langle x'^2\rangle(z)$, bzw.
$\langle y^2\rangle(z)$, $\langle yy'\rangle(z)$ und
$\langle y'^2\rangle(z)$. Wenn
...
\begin{equation} \label{eq:normemit}
		\eps_{x,n}
		= \beta\gamma\sqrt{\langle x^2\rangle(z)\langle x'^2\rangle(z)
...
wir danach von der Kameraaufnahme abziehen. Die Strahlgröße $\langle x^2 \rangle$
...
\hline
\end{tabular}
\caption{Messung der horizontalen Strahlgröße $\langle x^2 \rangle$ an Schirm 2
...
\hline
\end{tabular}
\caption{Messung der vertikalen Strahlgröße $\langle y^2 \rangle$ an Schirm 2
			in Abhängigkeit des Quadrupolstroms $I$ bei V46MATCH.}
	\label{tab:yemitquad}
\end{table}
...
\begin{equation}
	\eps_{x,n} = (0,136 \pm 0,005)\text{ m}\cdot\text{mrad.} \nonumber
\end{equation}
...
\begin{equation}
	\eps_{y,n} = (0,222 \pm 0,011)\text{ m}\cdot\text{mrad.} \nonumber
\end{equation}
...
\begin{equation}
	\eps_{x,n} = (0,119 \pm 0,016)\text{ m}\cdot\text{mrad} \nonumber
\end{equation}
und
\begin{equation}
	\eps_{y,n} = (0,35 \pm 0,02)\text{ m}\cdot\text{mrad.} \nonumber
\end{equation}